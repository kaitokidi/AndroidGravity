...
public:
    ...
    std::string display_recieve_text(sf::RenderWindow* window, std::string s, sf::Color c ){
        open = true;
        std::string recieved = "";
    ...
    void displayText(sf::RenderWindow* window, std::string s , sf::Color c ){
        open = true;
        t.setString(s);
        t.setPosition(window->getSize().x/2 - ((s.size()/2)*t.getCharacterSize()), window->getSize().y/2 - t.getCharacterSize()/2);
        window->clear(c);
    ...
    void drawText(sf::RenderWindow* window, std::string s , sf::Color c ){
        open = true;
        t.setString(s);
        t.setPosition(window->getSize().x/2 - ((s.size()/2)*t.getCharacterSize()), window->getSize().y/2 - t.getCharacterSize()/2);
        window->clear(c);
    ...
    void displayTextPos(sf::RenderWindow* window, std::string s , sf::Color c , float posx, float posy ){
        open = true;
        t.setString(s);
    ...
    void drawTextPos(sf::RenderWindow* window, std::string s , sf::Color c , float posx, float posy ){
        open = true;
        t.setString(s);
        t.setPosition(posx, posy);
        t.setColor(c);
